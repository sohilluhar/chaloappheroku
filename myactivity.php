                                            ...
                                            <div class="bootstrap-media mt-2">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        <a href="chats.php">
                                                            <h5 class="mt-2">Chalo Beach
                                                                <span class="p-style float-right">Tue, 17
                                                                        Mar</span>
                                                            </h5>
                                                        </a>
                                                        <p class="text-dark">Active Activity</p>
                                                    </div>
                                                </div>
                                                </p>
                                        ...
                                        <div class="card-body">
                                            <div class="bootstrap-media mt-2">
                                                ...
                                                <p class="text-success mb-0">Sohil Luhar has accepeted your
                                                    proposed time !</p>
                                                <p class="text-dark">New Start time Feb 21, 2020 6:00 PM has been
                                                    updated in this activity</p>
                                        ...
                                        <div class="card-body">
                                            <div class="bootstrap-media mt-2">
                                                ...
                                                <p class="text-danger mb-0">You were removed from this activity
                                                    <button
                                                            class="btn btn-outline-danger btn-xs  float-right">Remove
                                                    </button>
                                                </p>
                                            ...
                                            <div class="bootstrap-media">
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p class="p-style text-dark" style="margin-top:-12px;">Male,
                                                            Mumbai
                                                ...
                                                <h5 class="text-primary" style="margin-top:-8px;">LetsGo Walking
                                                    <span class="
                                            float-right"> Wed 19,
                                                            Feb</span>
                                                </h5>
